...
a, b = input(), input()
if (((a != "красный") and (a != "синий") and (a != "желтый")) or ((b != "красный") and (b != "синий") and (b != "желтый"))) : print("ошибка цвета")
elif (a == b) : print(a)
elif (a == "красный" and b == "синий") or (b == "красный" and a == "синий") : print("фиолетовый")
