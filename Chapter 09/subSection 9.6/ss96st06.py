...
# В первой строке дается число n (1 ≤ n≤ 25) – сдвиг, во второй строке даётся закодированное сообщение в виде строки со строчными
# латинскими буквами.
#
...
endS = ""
for c in s :
    if (ord(c) - n) < 97 : endS += chr(26+ord(c)-n)
    else : endS += chr(ord(c) - n)
print(endS)